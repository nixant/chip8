  ...
  case eventPayload event of
    KeyboardEvent keyboardEvent ->
      case ( keysymKeycode (keyboardEventKeysym keyboardEvent)
        ...
        (KeycodeQ, Pressed) ->
          (atomically $ modifyTVar k $ M.insert K4 True) >> eventLoop kb
        (KeycodeW, Released) ->
          (atomically $ modifyTVar k $ M.insert K5 False) >> eventLoop kb
        (KeycodeW, Pressed) ->
          (atomically $ modifyTVar k $ M.insert K5 True) >> eventLoop kb
        (KeycodeE, Released) ->
          (atomically $ modifyTVar k $ M.insert K6 False) >> eventLoop kb
        (KeycodeE, Pressed) ->
        ...
        (KeycodeV, Pressed) ->
          (atomically $ modifyTVar k $ M.insert KF True) >> eventLoop kb
