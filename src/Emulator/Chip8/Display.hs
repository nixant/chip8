...
chip8banner x y = concat
  [ (\p -> Draw (x + p) $ y + 0) <$> [0,1,2,3,4,6,10,12,13,14,15,16,18,19,20,21,22,24,25,26,27,28]
  , (\p -> Draw (x + p) $ y + 1) <$> [0,6,10,14,18,22,24,28]
  , (\p -> Draw (x + p) $ y + 2) <$> [0,6,7,8,9,10,14,18,19,20,21,22,24,25,26,27,28]
  , (\p -> Draw (x + p) $ y + 3) <$> [0,6,10,14,18,24,28]
  , (\p -> Draw (x + p) $ y + 4) <$> [0,1,2,3,4,6,10,12,13,14,15,16,18,24,25,26,27,28]
  ]