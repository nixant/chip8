...
-}
chip8banner = concat
  [ (\x -> Draw (18 + x) 14) <$> [0,1,2,3,4,6,10,12,13,14,15,16,18,19,20,21,22,24,25,26,27,28]
  , (\x -> Draw (18 + x) 15) <$> [0,6,10,14,18,22,24,28]
  , (\x -> Draw (18 + x) 16) <$> [0,6,7,8,9,10,14,18,19,20,21,22,24,25,26,27,28]
  , (\x -> Draw (18 + x) 17) <$> [0,6,10,14,18,24,28]
  , (\x -> Draw (18 + x) 18) <$> [0,1,2,3,4,6,10,12,13,14,15,16,18,24,25,26,27,28]
  ]